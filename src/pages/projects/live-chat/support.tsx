...
const LiveChatSupport: NextPage = () => {
  return (
    <div>
      <Head>
        <title>Eduardo Santos - LiveChat Support</title>
        <meta
          name="description"
          content="Support page for the LiveChat app with contact details and response time."
        />
        ...
        <SupportCard>
          <SupportBody>
            <PrivacyPolicyBody className="support_body">
              <h1>LiveChat Support</h1>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LiveChat is a Kotlin Multiplatform chat prototype.
              ...
              <h2>Last Updated</h2>
              <p className="support_meta">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;January 26, 2026</p>
            </PrivacyPolicyBody>
          </SupportBody>
        </SupportCard>
      </SupportPage>
