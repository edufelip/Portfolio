    ...
    <div>
      ...
      <main>
        <PrivacyPolicyBody>
          ...
          <p>
            Finn has zero tolerance for child sexual abuse and exploitation (CSAE). We do not allow
            content, behavior, or interactions that sexualize, endanger, or exploit minors. These
            standards apply to all users, content, and communication channels within the app.
          </p>
          ...
          <div className="bulletContainer">
            <ul>
              ...
              <li>
                Grooming, solicitation, sexual extortion, or attempts to arrange in-person contact
                with a minor for sexual purposes.
              </li>
              <li>
                Sharing, requesting, or distributing CSAE material, links, or instructions to obtain
                such material.
              </li>
              <li>
          ...
          <p>
            If you encounter CSAE-related content or behavior, report it immediately by contacting
            us at <a href="mailto:eduardofelipi@gmail.com">eduardofelipi@gmail.com</a>. We
            prioritize reports involving minors and will take appropriate action, which may include
            content removal, account suspension, and reporting to relevant authorities.
          </p>
          <p>
          ...
          <h2>Enforcement</h2>
          <p>
            We investigate reports, remove violating content, and disable accounts that breach these
            standards. Repeat or severe violations result in permanent bans. We may preserve and
            share relevant information with law enforcement when required or appropriate.
          </p>
