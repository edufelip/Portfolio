        ...
        <SupportCard>
          <SupportBody>
            <PrivacyPolicyBody className="support_body">
              ...
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Eduardo Santos built the <b>Finn</b> app as an Open
                Source app. This SERVICE is provided by Eduardo Santos at no cost and is intended
                for use as is. This page is used to inform visitors regarding my policies with the
                collection, use, and disclosure of Personal Information if anyone decided to use my
                Service. If you choose to use my Service, then you agree to the collection and use
                of information in relation to this policy. The Personal Information that I collect
                is used for providing and improving the Service. I will not use or share your
                information with anyone except as described in this Privacy Policy. The terms used
                in this Privacy Policy have the same meanings as in our Terms and Conditions, which
                are accessible at Finn unless otherwise defined in this Privacy Policy.
              </p>
              ...
              <div className="bulletcontainer">
                <p>
                  ...
                  including but not limited to name,email. The information that I request will be
                  retained on your device and is not collected by me in any way. The app does use
                  third-party services that may collect information used to identify you. Link to
              ...
              <div className="bulletContainer">
                <p>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I may employ third-party companies and individuals
              ...
              <p>
                ...
                third parties have access to their Personal Information. The reason is to perform
                the tasks assigned to them on our behalf. However, they are obligated not to
              ...
              <p>
                ...
                it. But remember that no method of transmission over the internet, or method of
              ...
              <p>
                ...
                external sites are not operated by me. Therefore, I strongly advise you to review
                the Privacy Policy of these websites. I have no control over and assume no
              ...
              <p>
                ...
                13. I do not knowingly collect personally identifiable information from children
                under 13 years of age. In the case I discover that a child under 13 has provided me
                with personal information, I immediately delete this from our servers. If you are a
              ...
              <p>
                ...
                policy is effective as of 2023-06-24
              </p>
              <h2>Contact Us</h2>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If you have any questions or suggestions about my
                Privacy Policy, do not hesitate to contact me at eduardofelipi@gmail.com.
              </p>
            </PrivacyPolicyBody>
          </SupportBody>
        </SupportCard>
