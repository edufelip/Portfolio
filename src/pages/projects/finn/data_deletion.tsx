          ...
          <SupportBody>
            <PrivacyPolicyBody className="support_body">
              ...
              <p>
                ...
                value your privacy and provide a simple way to manage your data. If you wish to
                delete your account and associated data, please follow the instructions below.
              </p>
              ...
              <div className="bulletContainer">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Email Request:</strong> Send an email to <b>eduardofelipi@gmail.com</b>{' '}
                    with the subject &quot;Finn Account Deletion Request&quot;. Please include the
              ...
              <div className="bulletContainer">
                ...
                <ul>
                  <li>
                    Anonymized logs for technical stability and security purposes (retained for up
                    to 90 days).
                  </li>
              ...
              <p>
                ...
                deactivated. All personal data listed above will be permanently purged from our
                active databases within <b>30 days</b>.
              </p>
